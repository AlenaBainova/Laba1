...
print ('В исходном датасете содержалось оценок', KolOtm, 'из них', KoiOtmPI101, 'оценок относятся к группе ПИ101', '\n','В датасете находятся оценки', KolStudPI101,'студентов со следующими личными номерами (по ПИ101):', NunberP101, '\n','Используемые формы контроля:', Control, '\n','Данные представлены по следующим учебным годам:', Years)